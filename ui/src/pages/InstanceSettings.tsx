...
export function InstanceSettings() {
  ...
  if (heartbeatsQuery.isLoading) {
    return <div className="text-sm text-muted-foreground">Carregando heartbeats...</div>;
  }
    ...
    <div className="max-w-5xl space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Agentes com heartbeat programado (pulsação de tempo) ativado em todas as suas organizações.
        </p>
      </div>
        ...
        {anyEnabled && (
          <Button
            ...
            onClick={() => {
              ...
              if (!window.confirm(`Desativar heartbeats para todos os ${enabledCount} ${noun} ativados?`)) {
                return;
              }
      ...
      {agents.length === 0 ? (
        <EmptyState
          icon={Clock3}
          message="Nenhum heartbeat corresponde aos critérios atuais."
        />
      ) : (
                  ...
                  {group.agents.map((agent) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {agent.schedulerActive ? "Ligado" : "Desligado"}
                        </Badge>
                        <Link
                        ...
                        <span className="ml-auto flex items-center gap-1.5 shrink-0">
                          ...
                          >
                            {saving ? "..." : agent.heartbeatEnabled ? "Desativar Heartbeat" : "Ativar Heartbeat"}
                          </Button>
                        </span>
                      </div>
                    );
