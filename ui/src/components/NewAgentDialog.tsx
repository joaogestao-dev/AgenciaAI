          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Recomendamos deixar seu CEO criar o agente — ele conhece a
                  estrutura da organização e pode configurar subordinações, permissões e
                  adaptadores.
                </p>
              </div>
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Escolha o tipo de adaptador para a configuração avançada.
                </p>
              </div>
